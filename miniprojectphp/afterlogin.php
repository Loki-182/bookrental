  ...
  <header id="home">
    ...
    <nav id="Home">
      <ul>
        ...
        <li><a href="#contact"><?php echo $_SESSION['user_name'] ?></a></li>
        <li><a href="logout.php" target="_blank"><button>Logout</button></a></li>
      </ul>
    </nav>
  </header>
  <main>
...
<div class="container">
    ...
    <div class="books-container" id="Books">
      <div class="book">
        ...
        <p>Author: Sadhguru</p>
        <p>Price: Rs 40</p>
        <a href="rentbook.html"><button>Rent Now</button></a><br>
